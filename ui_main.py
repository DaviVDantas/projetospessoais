...
"")
        ...
        self.btn_cadastra_produto = QPushButton(self.frame_2)
        self.btn_cadastra_produto.setObjectName(u"btn_cadastra_produto")
        self.btn_cadastra_produto.setMinimumSize(QSize(100, 27))
...
"")
        ...
        self.verticalLayout_3.addWidget(self.btn_cadastra_produto)
...
"")
        ...
        self.pg_CadastraProduto = QWidget()
        self.pg_CadastraProduto.setObjectName(u"pg_CadastraProduto")
        self.verticalLayout_14 = QVBoxLayout(self.pg_CadastraProduto)
        self.verticalLayout_14.setObjectName(u"verticalLayout_14")
        self.horizontalLayout_22 = QHBoxLayout()
        self.horizontalLayout_22.setObjectName(u"horizontalLayout_22")
        self.label_nfe = QLabel(self.pg_CadastraProduto)
        self.label_nfe.setObjectName(u"label_nfe")

        self.horizontalLayout_22.addWidget(self.label_nfe)

        self.txt_nfe = QLineEdit(self.pg_CadastraProduto)
        self.txt_nfe.setObjectName(u"txt_nfe")

        self.horizontalLayout_22.addWidget(self.txt_nfe)
        ...
        self.txt_serie = QLabel(self.pg_CadastraProduto)
        self.txt_serie.setObjectName(u"txt_serie")

        self.horizontalLayout_23.addWidget(self.txt_serie)

        self.txt_serie_2 = QLineEdit(self.pg_CadastraProduto)
        self.txt_serie_2.setObjectName(u"txt_serie_2")

        self.horizontalLayout_23.addWidget(self.txt_serie_2)
        ...
        self.txt_emissao = QLabel(self.pg_CadastraProduto)
        self.txt_emissao.setObjectName(u"txt_emissao")

        self.horizontalLayout_21.addWidget(self.txt_emissao)

        self.txt_emissao_2 = QLineEdit(self.pg_CadastraProduto)
        self.txt_emissao_2.setObjectName(u"txt_emissao_2")

        self.horizontalLayout_21.addWidget(self.txt_emissao_2)
        ...
        self.txt_chave = QLabel(self.pg_CadastraProduto)
        self.txt_chave.setObjectName(u"txt_chave")

        self.horizontalLayout_24.addWidget(self.txt_chave)

        self.txt_chave_2 = QLineEdit(self.pg_CadastraProduto)
        self.txt_chave_2.setObjectName(u"txt_chave_2")

        self.horizontalLayout_24.addWidget(self.txt_chave_2)
        ...
        self.txt_cnpj = QLabel(self.pg_CadastraProduto)
        self.txt_cnpj.setObjectName(u"txt_cnpj")

        self.horizontalLayout_25.addWidget(self.txt_cnpj)

        self.txt_cnpj_2 = QLineEdit(self.pg_CadastraProduto)
        self.txt_cnpj_2.setObjectName(u"txt_cnpj_2")

        self.horizontalLayout_25.addWidget(self.txt_cnpj_2)
        ...
        self.txt_emitente = QLabel(self.pg_CadastraProduto)
        self.txt_emitente.setObjectName(u"txt_emitente")

        self.horizontalLayout_20.addWidget(self.txt_emitente)

        self.txt_emitente_2 = QLineEdit(self.pg_CadastraProduto)
        self.txt_emitente_2.setObjectName(u"txt_emitente_2")

        self.horizontalLayout_20.addWidget(self.txt_emitente_2)
        ...
        self.txt_total = QLabel(self.pg_CadastraProduto)
        self.txt_total.setObjectName(u"txt_total")

        self.horizontalLayout_26.addWidget(self.txt_total)

        self.txt_total_2 = QLineEdit(self.pg_CadastraProduto)
        self.txt_total_2.setObjectName(u"txt_total_2")

        self.horizontalLayout_26.addWidget(self.txt_total_2)
        ...
        self.label_item = QLabel(self.pg_CadastraProduto)
        self.label_item.setObjectName(u"label_item")

        self.horizontalLayout_19.addWidget(self.label_item)

        self.lineEdit_item = QLineEdit(self.pg_CadastraProduto)
        self.lineEdit_item.setObjectName(u"lineEdit_item")

        self.horizontalLayout_19.addWidget(self.lineEdit_item)
        ...
        self.label_cod_item = QLabel(self.pg_CadastraProduto)
        self.label_cod_item.setObjectName(u"label_cod_item")

        self.horizontalLayout_32.addWidget(self.label_cod_item)

        self.txt_cod_item = QLineEdit(self.pg_CadastraProduto)
        self.txt_cod_item.setObjectName(u"txt_cod_item")

        self.horizontalLayout_32.addWidget(self.txt_cod_item)
        ...
        self.label_Quantidade = QLabel(self.pg_CadastraProduto)
        self.label_Quantidade.setObjectName(u"label_Quantidade")

        self.horizontalLayout_27.addWidget(self.label_Quantidade)

        self.txt_Quantidade = QLineEdit(self.pg_CadastraProduto)
        self.txt_Quantidade.setObjectName(u"txt_Quantidade")

        self.horizontalLayout_27.addWidget(self.txt_Quantidade)
        ...
        self.label_descricao = QLabel(self.pg_CadastraProduto)
        self.label_descricao.setObjectName(u"label_descricao")

        self.horizontalLayout_31.addWidget(self.label_descricao)

        self.txt_descricao = QLineEdit(self.pg_CadastraProduto)
        self.txt_descricao.setObjectName(u"txt_descricao")

        self.horizontalLayout_31.addWidget(self.txt_descricao)
        ...
        self.label_medida = QLabel(self.pg_CadastraProduto)
        self.label_medida.setObjectName(u"label_medida")

        self.horizontalLayout_28.addWidget(self.label_medida)

        self.txt_medida = QLineEdit(self.pg_CadastraProduto)
        self.txt_medida.setObjectName(u"txt_medida")

        self.horizontalLayout_28.addWidget(self.txt_medida)
        ...
        self.label_valor = QLabel(self.pg_CadastraProduto)
        self.label_valor.setObjectName(u"label_valor")

        self.horizontalLayout_18.addWidget(self.label_valor)

        self.txt_valor = QLineEdit(self.pg_CadastraProduto)
        self.txt_valor.setObjectName(u"txt_valor")

        self.horizontalLayout_18.addWidget(self.txt_valor)
        ...
        self.label_data = QLabel(self.pg_CadastraProduto)
        self.label_data.setObjectName(u"label_data")

        self.horizontalLayout_29.addWidget(self.label_data)

        self.txt_data = QLineEdit(self.pg_CadastraProduto)
        self.txt_data.setObjectName(u"txt_data")

        self.horizontalLayout_29.addWidget(self.txt_data)


        self.verticalLayout_14.addLayout(self.horizontalLayout_29)

        self.btn_cds = QPushButton(self.pg_CadastraProduto)
        self.btn_cds.setObjectName(u"btn_cds")
        self.btn_cds.setStyleSheet(u"QPushButton{\n"
"	color: rgb(0,0,10);\n"
"    border-radius: 10px; \n"
"	font-size: 16px; \n"
"	background-color: #fff;\n"
...
"")
        ...
        self.verticalLayout_14.addWidget(self.btn_cds)

        self.Pages.addWidget(self.pg_CadastraProduto)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_cadastra_produto.setText(QCoreApplication.translate("MainWindow", u"Cadastra Produto", None))
        ...
        self.label_nfe.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:16pt;\">Nfe</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_nfe.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">NFe</span></p></body></html>", None))
        self.txt_serie.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Serie</span></p></body></html>", None))
        self.txt_emissao.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Data_Emissao</span></p></body></html>", None))
        self.txt_chave.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Chave</span></p></body></html>", None))
        self.txt_cnpj.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">CNPJ</span></p></body></html>", None))
        self.txt_emitente.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Emitente</span></p></body></html>", None))
        self.txt_total.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Total_NFe</span></p></body></html>", None))
        self.label_item.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Item</span></p></body></html>", None))
        self.label_cod_item.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Cod_Item</span></p></body></html>", None))
        self.label_Quantidade.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Quantidade</span></p></body></html>", None))
        self.label_descricao.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Descri\u00e7\u00e3o</span></p></body></html>", None))
        self.label_medida.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Unidade_Medida</span></p></body></html>", None))
        self.label_valor.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Valor Produto</span></p></body></html>", None))
        self.label_data.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">Data_Importa\u00e7\u00e3o</span></p></body></html>", None))
        self.btn_cds.setText(QCoreApplication.translate("MainWindow", u"Cadastra", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><br/></p><p align=\"center\"><span style=\" font-size:24pt; color:#ffffff;\">Sistema de gerenciamento</span></p><p align=\"center\"><br/></p></body></html>", None))
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><br/></p><p align=\"center\"><span style=\" font-size:14pt; font-weight:600; color:#ffffff;\">CADASTRAR USU\u00c1RIO</span></p></body></html>", None))
        ...
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:16pt; font-weight:600; color:#ffffff;\">Desenvolvedor:Davi Dantas</span></p></body></html>", None))
        self.label_27.setText("")
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:16pt;\">61 986723790</span></p></body></html>", None))
        self.label_28.setText("")
        self.label_29.setText("")
        self.label_21.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:16pt;\">davidantas808@gmail.com</span></p></body></html>", None))
